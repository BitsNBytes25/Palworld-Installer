...
world:
  ...
  - name: Pal Egg Default Hatching Time
    ...
    type: float
    help: "Default hatching time for HUGE eggs in hours, (large and normal eggs will be even faster)."
  ...
  - name: Public Port
    ...
    type: int
    help: "Public port Palworld listens on"
    group: Settings
    default: 8211
...
service:
  - name: Public Lobby
    ...
    type: bool
    default: true
  - name: Use Perf Threads
    key: useperfthreads
    section: flag
    group: Settings
    type: bool
    default: true
  - name: No Async Loading Thread
    key: NoAsyncLoadingThread
    section: flag
    group: Settings
    type: bool
    default: true
  - name: Use Muilthread For DS
    key: UseMuilthreadForDS
    section: flag
    group: Settings
    type: bool
    default: true
  - name: Number Of Worker Threads Server
    key: NumberOfWorkerThreadsServer
    section: flag
    group: Settings
    type: int
EOF
